...
Done: remediate findings; deployment script; ownership model; upgrade mechanism; pause/force-transfer events, coverage and docs; clippy and rustfmt gates over the workspace in CI.
